...
namespace BehaviourAPI.UnityToolkit
{
    ...
    public class SmartObjectLocator : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // Verificar si ha pasado el tiempo suficiente para realizar una comprobaci�n
        ...
        public void LocateObjects()
        {
            ...
            SmartObject[] allSmartObjects = FindObjectsByType<SmartObject>(FindObjectsSortMode.InstanceID);
