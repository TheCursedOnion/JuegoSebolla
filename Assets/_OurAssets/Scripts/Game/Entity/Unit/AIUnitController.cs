...
namespace CursedOnion.Game.Entity
{
    public class AIUnitController : EntityComponentController
    {
        ...
        public List<Vector3> attackPositions = new();
        ...
        public bool EnemyInAttackRange()
        {
            ...
            {
                AStarPathFinder.InsertManhattanAttackGridPositions(reachableAttackPositions, unit.Grid, startGridPos, 2, false);
            }
            else
            {
        ...
        public bool SearchAndFindPath()
        {
            ...
            float maxAllowedDistance = unit.Stats.MovementStat * 2.5f; // demasiado lejos, no te busca
